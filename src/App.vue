  ...
  <div id="app">
    ...
    <div class = "container-fluid p-4">
      ...
      <div class="row py-2">
        ...
        <div class="col-2">
          <button class="btn btn-primary" v-on:click="addNewTodo" :disabled="this.newItemText == '' ||
           this.newItemText == ' ' || this.newItemText == '  ' " >
            Dodaj</button>
        </div>
      </div>
      <div class="row bg-secondary py-2 mt-2 text-white">
        ...
        <div class="col text-center">
          <button class="btn btn-sm btn-warning" v-on:click="deletedCompleted">
            Usuń zakończone
          </button>
        </div>    
      </div>
